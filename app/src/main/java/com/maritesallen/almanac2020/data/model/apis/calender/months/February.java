 ...
 */
public class February implements Parcelable {
    @SerializedName("date")
    @Expose
    private String date;
    ...
    public static final Creator<February> CREATOR = new Creator<February>() {
        @Override
        public February createFromParcel(Parcel in) {
            return new February(in);
        }

        @Override
        public February[] newArray(int size) {
            return new February[size];
        }
    };
