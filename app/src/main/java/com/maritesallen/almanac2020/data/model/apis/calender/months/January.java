 ...
 */
public class January implements Parcelable {
    @SerializedName("date")
    @Expose
    private String date;
    ...
    public static final Creator<January> CREATOR = new Creator<January>() {
        @Override
        public January createFromParcel(Parcel in) {
            return new January(in);
        }

        @Override
        public January[] newArray(int size) {
            return new January[size];
        }
    };
