...
//    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
    ...
    /**
     * <p>Returns a filter that can be used to constrain CalendarData with a filtering
     * pattern.</p>
     * <p>
     * <p>This method is usually implemented by {@link Adapter}
     * classes.</p>
     *
     * @return a filter used to constrain CalendarData
     */
    @Override
...
//            adapterFilterCalls.callBackToActivity(String.valueOf(filteredArrayList.size()));
         ...
         * @param filteredArrayList This list will return with added CalendarData
         */
