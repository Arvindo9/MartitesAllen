 ...
 */
public class BillingConfigPremium {
    static final String TAG = BillingConfigPremium.class.getSimpleName();
    private BillingConfigListener callback;

    public interface BillingConfigListener{
        void loading(boolean status);

        void onConsumeFinishedPremium(Purchase purchase, IabResult result);
    }

    private static String PURCHASE_ITEM_ID = "";
...
//    private String base64EncodedPublicKey = "";
    ...
    private BillingConfigPremium(){
    }

    public static BillingConfigPremium getInstance(){
        return new BillingConfigPremium();
    }
    ...
    public void setPurchaseItemId(String productId){
...
//                complain("Error purchasing: " + result);
    ...
    IabHelper.OnConsumeFinishedListener mConsumeFinishedListener = new IabHelper.OnConsumeFinishedListener() {
        public void onConsumeFinished(Purchase purchase, IabResult result) {
            ...
            callback.onConsumeFinishedPremium(purchase, result);
            callback.loading(false);
