 ...
 */
public class GhostMonthPager extends PagerAdapter {

    private final ArrayList<Slider> list;
    private LayoutInflater layoutInflater;

    public GhostMonthPager(Context context, ArrayList<Slider> list) {
        this.list = list;
    ...
    public Object instantiateItem(@NotNull ViewGroup container, final int position) {
            ...
            AdapterGhostMonthBinding binding = DataBindingUtil.inflate(layoutInflater, R.layout.adapter_ghost_month,
                    container, false);
            binding.setData(new GhostMonthViewModel(list.get(position)));
