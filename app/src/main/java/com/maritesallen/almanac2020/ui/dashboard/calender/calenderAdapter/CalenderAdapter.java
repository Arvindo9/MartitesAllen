        ...
        return new ViewHolder<AdapterCalenderBinding, CalendarModel>(binding) {
            ...
            protected void doSomeWorkHere(AdapterCalenderBinding binding, CalendarModel data, int position) {
                ...
                if(data.getMonthId() == currentMonth && data.getDateInt() == currentDay){
                    binding.calenderDate.setBackgroundColor(itemView.getResources().getColor(R.color.white));
                    binding.calenderDate.setTextColor(itemView.getResources().getColor(R.color.colorPrimary));
                }
                else if(data.getMonthId() != currentMonth && data.getDateInt() == currentDay){
                    binding.calenderDate.setBackgroundColor(itemView.getResources().getColor(R.color.colorPrimary));
                    binding.calenderDate.setTextColor(itemView.getResources().getColor(R.color.white));
                }
/*
